        ...
        <div className='flex flex-col md:flex-row justify-between md:space-x-10 mt-8'>
            ...
            <div className='border p-2 mb-6'>
              ...
              <div className={`space-y-4 ${billingToggle ? "" : "hidden"}`}>
                <div>
                  ...
                  <input type="text" name='name' className='w-full px-3 py-2 border rounded'
                  placeholder='Enter your name'/>
                </div>
            <div>
                  <label htmlFor=""  className='block text-gray-700'>Email</label>
                  <input type="email" name='email' className='w-full px-3 py-2 border rounded'
                  placeholder='Enter your email'/>
              </div>
              <div>
                  <label htmlFor="" className='block text-gray-700'>Phone</label>
                  <input type="tel" name='phone' className='w-full px-3 py-2 border rounded'
           ...
           {/*shipping*/}
            ...
            <div>
                  ...
                  <input type="text" name='city' className='w-full px-3 py-2 border rounded'
                  placeholder='Enter your city'
                  onChange={(e) => setShippingInfo({...shippingInfo, city: e.target.value})}/>
              </div>
              <div>
                  <label htmlFor="" className='block text-gray-700'>Zip Code</label>
                  <input type="text" name='zip' className='w-full px-3 py-2 border rounded'
